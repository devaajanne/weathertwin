...
public class ConversionTests {
    ...
    public void testWeatherDataTempConversionToMetric() {
        WeatherData weatherData = new WeatherData(1L, 25.55, 25.66, "Helsinki", "FI", "Finland", 274.15, "Snow");
        Double metricTemp = 1.0;
    ...
    public void testWeatherDataTempConversionToImperial() {
        WeatherData weatherData = new WeatherData(1L, 25.55, 25.66, "Helsinki", "FI", "Finland", 255.93, "Snow");
        Double imperialTemp = 1.0;
